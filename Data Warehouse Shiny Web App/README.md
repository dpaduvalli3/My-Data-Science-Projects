...
This is a data warehouse application which allows users to read and make direct changes to the postgres database. This application has been built in shiny rstudio. 
